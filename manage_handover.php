...
<div class="container-fluid">
    <form action="" id="manage-handover">
        ...
        <div class="form-group" style="display: none">
            <label for="" class="control-label">Diterima Oleh: </label>
            ...
            success: function(resp) {
                if (resp) {
                    ...
                    if (resp.status == 1) {
                        ...
                        _html += '<p>Nama Pasien: ' + resp.data.patient + '<b></b></p>';
                        _html += '<p>Golongan Darah: ' + resp.data.blood_group + '<b></b></p>';
                        _html += '<p>Volume Didonorkan: ' + resp.data.volumeL + ' L<b></b></p>';
                        _html += '<p>Email : ' + resp.data.email_pasien + '<b></b></p>';
