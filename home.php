                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            <div class="card-body bg-light">
                                <div class="card-body text-dark">
                                    <span class="float-right summary_icon"><i class="fa-solid fa-users icon-home "></i></span>
                                    <h4><b>
                                            <?php echo $conn->query("SELECT * FROM donors")->num_rows ?>
                                        </b></h4>
                                    <p><b>Total Pendonor</b></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            <div class="card-body bg-light">
                                <div class="card-body text-dark">
                                    <span class="float-right summary_icon"> <i class="fa-solid fa-droplet icon-home"></i></span>
                                    <h4><b>
                                            <?php echo $conn->query("SELECT * FROM requests where date(date_created) = '" . date('Y-m-d') . "' ")->num_rows ?>
                                        </b></h4>
                                    <p><b>Requests Darah Hari Ini</b></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="card">
                            <div class="card-body bg-light">
                                <div class="card-body text-dark">
                                    <span class="float-right summary_icon"> <i class="fa-solid fa-thumbs-up icon-home"></i></span>
                                    <h4><b>
