			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right"><a class="btn btn-danger btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_handover">
					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php
								$i = 1;
								$handovers = $conn->query("SELECT hr.*,r.patient,r.blood_group, r.volume,r.ref_code, r.email_pasien, r.nowa FROM handedover_request hr inner join requests r on r.id = hr.request_id order by date(hr.date_created) desc ");
								...
								?>
									<tr>
										...
										<td class="">
											<p>Volume Donor (L): <b><?php echo ($row['volume'] / 1000) . ' L' ?></b></p>
											<p>Diterima Oleh: <b><?php echo ucwords($row['picked_up_by']) ?></b></p>
											<p>Email : <b><?php echo ($row['email_pasien']) ?></b></p>
											<p>No WhatsApp: <b><?php echo ($row['nowa']) ?></b></p>
										</td>
