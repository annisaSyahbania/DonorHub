			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Donors</b>
						<span class="float:right"><a class="btn btn-danger btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_donor">
								<i class="fa fa-plus"></i> Tambah</a></span>
					</div>
					<div class="card-body">
								...
								?>
									<tr>
										...
										<td class="">
											...
											<p>Alamat: <b><?php echo $row['address']; ?></b></p>
										</td>
										<td>
