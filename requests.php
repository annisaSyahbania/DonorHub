			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right"><a class="btn btn-danger btn-block btn-sm col-sm-2 float-right" href="javascript:void(0).php" id="new_request">
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td class="">
											<p>Volume Dibutuhkan: <b><?php echo ($row['volume'] / 1000) . ' L' ?></b></p>
											<p>NIK: <b><?php echo ucwords($row['nik']) ?></b></p>
											<p>Email: <b><?php echo ucwords($row['email_pasien']) ?></b></p>
											<p>No WhatsApp: <b><?php echo ucwords($row['nowa']) ?></b></p>
											<p>Alamat: <b><?php echo ucwords($row['alamat']) ?></b></p>
										</td>
